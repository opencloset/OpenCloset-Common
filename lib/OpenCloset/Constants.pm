...
@ISA = qw/Exporter/;
@EXPORT_OK =
    qw/$DEFAULT_RENTAL_PERIOD $SHIPPING_BUFFER $SHIPPING_DEADLINE_HOUR $MAX_EXTENSION_DAYS $DOES_WEAR_NULL $DOES_WEAR_YES $DOES_WEAR_MISC $DOES_WEAR_BOTH %DOES_WEAR_MAP %MAX_SUIT_TYPE_COUPON_PRICE %PAY_METHOD_MAP/;
