...
@EXPORT_OK = qw/$RENTABLE $RENTAL $RENTALESS $RESERVATION $CLEANING $REPAIR $LOST $DISCARD $RETURNED $PARTIAL_RETURNED $RETURNING
    ...
    $FITTING_ROOM19 $FITTING_ROOM20 $NOT_RENTAL $CANCEL_BOX $PAYBACK $NO_SIZE $BOXED $RECYCLE_1 $RECYCLE_2 $UNRECYCLE $CHOOSE_CLOTHES $CHOOSE_ADDRESS $PAYMENT_DONE $DEPOSIT_CONFIRMED $WAITING_SHIPPED $SHIPPED $DELIVERED $RETURN_REQUESTED/;
