...
@EXPORT_OK = qw/$RENTABLE $RENTAL $RENTALESS $RESERVATION $CLEANING $REPAIR $LOST $DISCARD $RETURNED $PARTIAL_RETURNED $RETURNING
    ...
    $FITTING_ROOM19 $FITTING_ROOM20 $NOT_RENTAL $CANCEL_BOX $PAYBACK $NO_SIZE $BOXED $RECYCLE_1 $RECYCLE_2 $UNRECYCLE $CHOOSE_CLOTHES $PAYMENT_DONE $DEPOSIT_CONFIRMED $WAITING_SHIPPED $SHIPPED $DELIVERED $RETURN_REQUESTED/;
...
our $PAYMENT_DONE      = 49;
our $DEPOSIT_CONFIRMED = 50;
our $WAITING_SHIPPED   = 51;
our $SHIPPED           = 52;
our $DELIVERED         = 53;
our $RETURN_REQUESTED  = 54;
...
our $LABEL_CHOOSE_CLOTHES    = '의류선택중';
...
our @ALL = (
    ...
    $CHOOSE_CLOTHES, $PAYMENT_DONE, $DEPOSIT_CONFIRMED, $WAITING_SHIPPED, $SHIPPED, $DELIVERED, $RETURN_REQUESTED
);
...
our @ALL_LABEL = (
    ...
    $LABEL_CHOOSE_CLOTHES, $LABEL_PAYMENT_DONE, $LABEL_DEPOSIT_CONFIRMED, $LABEL_WAITING_SHIPPED, $LABEL_SHIPPED, $LABEL_DELIVERED,
